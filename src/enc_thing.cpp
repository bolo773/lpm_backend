...
int main(void)
{
    ...
    std::ifstream image("image.png", std::ios::binary | std::ios::ate);
   ...
   // BIO_dump_fp(stdout,(const char *)ciphertext,ciphertext_len);
    ...
    std::ofstream image_final("enc_new.png", std::ios::binary | std::ios::ate);
    image_final.write((char *)ciphertext,ciphertext_len);
